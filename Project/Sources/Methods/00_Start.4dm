...
Case of 
	...
	Else 
		...
		$options.title:="Use the Process properties and Session properties command"+$cr+"and Filter the processes with Process activity command"
		
		$options.blog:="blog.4d.com"
		$options.info:="Processes and sessions"  //ex : "4D View Pro feature"
