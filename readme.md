# HDI_ImproveProcessAndSessionCommands

Use the new Process properties and Session properties command, and Filter the processes with Process activity command (4D 20 R7)
